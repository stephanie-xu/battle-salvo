...
public interface Player {
   ...
   * equal the number of ships on this player's board that have not sunk. Multiple shots at the
   * same location are allowed, but the automated player will never shoot at the same location
   * twice.
   *
